  ...
  return (
      <div className="px-2">
          <div className="w-[90%] mx-auto pb-28 mt-10">
              <h2 className=" text-main text-[1.6rem] mt-4">Create Post</h2>

              <div className="text-box mt-6">
                <div className="text-wrapper flex justify-between">
                    <div className="post-des flex mb-1">
                      <h3 className="mr-2 text-[1.1rem]  text-[#646464]">Post Descriptions</h3>
                      <img src="/icons/information-circle.svg" alt="info" />
                    </div>
            
                    <p>0/150</p> 
                </div>
                <textarea name="" id="" className="px-2 pt-2 w-full h-20 border-[1px] border-rounded-md outline-rounded-md resize-none border-outline outline-outline"></textarea>
              </div>
        ...
        {/* Media Section */}
              <div className="media mt-12">
                  <div className="post-des flex mb-1">
                      <h3 className="mr-2 text-[1.1rem]  text-[#646464]">Media Content</h3>
                      <img src="/icons/information-circle.svg" alt="info" />
                    </div>
              ...
              <div className="tone mt-8">
                <div className="text-wrapper flex justify-between mb-1">
                    <h3 className="mr-2 text-[1.1rem]  text-[#646464]">Tone of Voice</h3>
                    <p>0/3</p> 
                </div>
        ...
        {/* KEYWORDS  */}
              ...
              <div className="tone mt-8">
                <div className="text-wrapper flex justify-between mb-1">
                    <h3 className="mr-2 text-[1.1rem] text-[#646464]">Keywords</h3>
                    <p>0/5</p> 
                </div>
